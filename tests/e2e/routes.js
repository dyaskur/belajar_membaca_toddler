...
export const PAGE_META = {
  ...
  ...LEVEL_PAGES,
  '/stiker': { group: 'game', label: 'Buku Stiker', order: 1 },
  '/cocokkan': { group: 'game', label: 'Cocokkan', order: 2 },
  '/mesin': { group: 'game', label: 'Mesin Kata', order: 3 },
  '/ucapkan': { group: 'game', label: 'Ucapkan', order: 4 },
